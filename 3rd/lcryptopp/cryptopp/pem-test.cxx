...
// clang++ -DDEBUG=1 -g3 -O0 -Wall -Wextra -I./ pem-test.cpp -o pem-test.exe ./cryptopp/libcryptopp.a
// clang++ -DNDEBUG=1 -g3 -O2 -Wall -Wextra -I./ pem-test.cpp -o pem-test.exe ./cryptopp/libcryptopp.a
